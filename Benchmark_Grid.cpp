...
#define NLOOP (200 * lmax * lmax * lmax / lat / lat / lat)
  ...
  static double Sp4DWF(int Ls, int L)
  {
    RealD mass = 0.1;
    RealD M5 = 1.8;
    ...
    typedef DomainWallFermionF<SpWilsonImplD> Action;
    typedef typename Action::FermionField Fermion;
    typedef LatticeGaugeFieldF Gauge; // How do I know if this is Sp4?
  ...
  static double Sp4WF_2AS(int Ls, int L)
  {
    RealD mass = 0.1;
    RealD M5 = 1.8;
    ...
    ///////// Set Action ////////////
    typedef SpWilsonTwoIndexAntiSymmetricFermionD Action;
    typedef typename FermionAction::FermionField Fermion;
  ...
  // Do we also want SU(3) two index antisymmetric perhaps??
};
